...
// Copyright (c) 2011-2013 TakeoutCoin Developers.
...
uint256 hashGenesisBlock("0xb5f9b3947367b84cb1bede676d26b8dd84a447d3f935bbef1b748991454bad8a");
...
const string strMessageMagic = "TakeoutCoin Signed Message:\n";
...
static const int64 nTargetTimespan =  120 * 144; // 1 hr
...
if (pindexLast->nHeight+1 > 157250)
{
    ...
    // TakeoutCoin: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal TakeoutCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TakeoutCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xb5f9b3947367b84cb1bede676d26b8dd84a447d3f935bbef1b748991454bad8a");
    }
...
// Genesis block
		...
		assert(block.hashMerkleRoot == uint256("0x1082f47e3669ab93d5dabe83c9ed201975892c6c7b90bf3d7b85d26291a77479"));
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // TakeoutCoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
